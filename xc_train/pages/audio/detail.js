...
Page({
    ...
    audio_play: function(a) {
        var t = this, 
        e = t.data.list.audio_list,
         n = a.currentTarget.dataset.index;

      console.log(e[n].audio);

        i.audio_Id = t.data.id, 
        i.audio_on = e[n], 

        i.audio_curr = n, 

          // console.log(e[n].audio, "audio", payauto);

        i.innerAudioContext.src = e[n].audio,

        i.innerAudioContext.play(),
